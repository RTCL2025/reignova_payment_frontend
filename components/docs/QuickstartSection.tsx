...
const response = await fetch(\`\${process.env.PAYMENT_SERVICE_BASE_URL}/api/v1/checkouts\`, {
  ...
  body: JSON.stringify({
    ...
    returnUrl: "https://events.reignovatechnologies.com/checkout/callback"
  }),
});
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-3 mb-16">
          ...
          <p className="text-sm sm:text-base text-slate-600 leading-relaxed">
            Follow these simple steps to integrate Reignova Payment Service into
        ...
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <div className="relative pl-10 border-l-2 border-slate-200 pb-8 last:pb-0">
            ...
            <div className="space-y-3">
              ...
              <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
                Backend applications require valid Reignova Payment Service API
                credentials. Log in to the protected Admin Portal to generate
                your merchant API keys and webhook signing secret.
              </p>
              <div className="pt-1">
                <Link
                  href="/admin"
          ...
          <div className="relative pl-10 border-l-2 border-slate-200 pb-8 last:pb-0">
            ...
            <div className="space-y-3">
              ...
              <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
                Store your base URL and secret API key securely in server-side
                environment variables. Never expose real secrets in client-side
                code.
              </p>
          ...
          <div className="relative pl-10 border-l-2 border-slate-200 pb-8 last:pb-0">
            ...
            <div className="space-y-3">
              ...
              <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
                ...
                <code className="text-amber-700 bg-amber-50 px-1.5 py-0.5 rounded font-mono text-xs border border-amber-200">
          ...
          <div className="relative pl-10 border-l-2 border-slate-200 pb-8 last:pb-0">
            ...
            <div className="space-y-3">
              ...
              <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
                Redirect your customer&apos;s browser to the hosted checkout
                page at{" "}
                <code className="text-amber-700 bg-amber-50 px-1.5 py-0.5 rounded font-mono text-xs border border-amber-200">
                  /checkout/[publicToken]
                </code>{" "}
                where they select their mobile money operator (M-Pesa, Airtel
                Money, Tigo Pesa, Halopesa) and enter their phone number.
              </p>
            </div>
          </div>
          ...
          <div className="relative pl-10 border-l-2 border-slate-200">
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-lg font-bold text-slate-900">
                  Confirm Payment via Verified Webhook
                </h3>
              </div>
              <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
                Confirming payment must come from a verified backend callback or
                trusted status lookup—never rely solely on a frontend browser
                redirect. Receive the signed{" "}
                <code className="text-amber-700 bg-amber-50 px-1.5 py-0.5 rounded font-mono text-xs border border-amber-200">
                  checkout.completed
                </code>{" "}
                webhook to execute order fulfillment safely.
              </p>
              <div className="pt-2">
                <Button
                  asChild
                ...
                >
                  <Link href="/docs/webhooks">
                    Read Webhooks & Signature Verification Docs
                  </Link>
                </Button>
              </div>
            </div>
